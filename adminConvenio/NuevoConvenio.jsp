...
<table class="tablas" align="center">
	...
	<tr>
		<td class="renglones" colspan="6"><input type="text" name="nombreConvenio" style="width:100%"  onKeyPress='return soloNumeros(event)' value='<c:out value="${requestScope.datoConvenio.valor}" />'></td>
	</tr>
	...
	<tr>
		...
		<table>
			<tr>
				<td class="renglones" colspan="3" style="width: 200px; "><b>Fecha de Inicio</b></td>
				<td><input type='text' colspan="3" name='fecha' class='caj' readonly='true' id='f_date_a' size='13' value='<c:out value="${requestScope.datoConvenio.fecha}" />'>
				<button type='button' id='f_trigger_a'>...</button>
				<script type='text/javascript'>
				    			Calendar.setup({
					    			inputField     :    'f_date_a',
				...
				<td style="width: 189px; "><input type='text' name='fechafinal' class='caj' readonly='true' id='f_date_a' size='13' value='<c:out value="${requestScope.datoConvenio.fechaFinalizacion}" />'>
				<button type='button' id='f_trigger_ab'>...</button>
				<script type='text/javascript'>
				    			Calendar.setup({
					    			inputField     :    'f_date_a',
					    			ifFormat       :    '%d/%m/%Y',
