...
<div align="center">
	...
	<c:if test="${(sessionScope.datosConv.convNumero==1 or sessionScope.datosConv.convNumero==3 or sessionScope.datosConv.convNumero==11) and (sessionScope.persona.papel!=3 and sessionScope.persona.papel!=5)}">
	...
	<c:if test="${(sessionScope.datosConv.convNumero==1 or sessionScope.datosConv.convNumero==3 or sessionScope.datosConv.convNumero==11) and (sessionScope.persona.papel==3 or sessionScope.persona.papel==5)}">
	...
	<c:if test="${((sessionScope.datosConv.convNumero==1 or sessionScope.datosConv.convNumero==3 or sessionScope.datosConv.convNumero==11)and (sessionScope.persona.papel==3 or sessionScope.persona.papel==5))or((sessionScope.datosConv.convNumero==4 or sessionScope.datosConv.convNumero==12)and (sessionScope.persona.papel!=3 and sessionScope.persona.papel!=5))}">
