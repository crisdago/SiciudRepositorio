				...
				if(usuario.getPerfil()==13){
					...
					if(convocatoriaOBJ!=null){
						System.out.println("------>"+convocatoriaOBJ.getConvAno()+"  -- "+convocatoriaOBJ.getConvNumero());						
						   if(convocatoriaOBJ.getConvAno()==2013 && (convocatoriaOBJ.getConvNumero()==1 || convocatoriaOBJ.getConvNumero()==2 || convocatoriaOBJ.getConvNumero()==3 || convocatoriaOBJ.getConvNumero()==4 ||convocatoriaOBJ.getConvNumero()==11||convocatoriaOBJ.getConvNumero()==12)){
